...
public class PathRecord {
	...
	private List<AMapLocation> mPathRecordPoints = new ArrayList<AMapLocation>();
	...
	public List<AMapLocation> getmPathRecordPoints() {
		return mPathRecordPoints;
	}

	public void setmPathRecordPoints(List<AMapLocation> mPathRecordPoints) {
		this.mPathRecordPoints = mPathRecordPoints;
	}
	...
	public void addRecordPoint(AMapLocation point){
		mPathRecordPoints.add(point);
	}
	@Override
