...
public class RecordShowActivity extends Activity implements
	...
	private List<LatLng> mOriginRecordsLatLngList;
	...
	private void setupRecord() {
		...
		if (mRecord != null) {
			...
			mOriginRecordsLatLngList = Util.parseLatLngList(mRecord.getmPathRecordPoints());
			addOriginTrace(startLatLng, endLatLng, mOriginLatLngList, mOriginRecordsLatLngList);
	 ...
	 * @param endPoint
	 * @param originList
	 * @param originRecordsList
	 */
	private void addOriginTrace(LatLng startPoint, LatLng endPoint,
			List<LatLng> originList, List<LatLng> originRecordsList) {
		...
		for(LatLng latLng : originRecordsList){
